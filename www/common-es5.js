...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppDaoTableServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_model_tabela__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/model/tabela */
    "./src/model/tabela.ts");

    var TableService_1;

    var TableService = TableService_1 =
    /*#__PURE__*/
    function () {
      function TableService(tabela, storage) {
        var _this = this;
        ...
        this.storage.ready().then(function () {
          _this.storage.get(TableService_1.PAYERS).then(function (data) {
            if (data === undefined || data === null) {
              _this.tabela.recebeuDe = new Array();
            } else {
              _this.tabela.recebeuDe = data;
            }
          });
        });
      }
            ...
            return regeneratorRuntime.wrap(function _callee$(_context10) {
              while (1) {
                switch (_context10.prev = _context10.next) {
                  case 0:
                    _context10.next = 2;
                    return this.storage.set(TableService_1.PAYERS, this.tabela.recebeuDe);
    ...
    TableService = TableService_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_model_tabela__WEBPACK_IMPORTED_MODULE_3__["Tabela"], _ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]])], TableService);
    /***/
  }
}]);
